...
public class PlaceholderUtil {
	...
	public static List<String> parsePlaceholders(List<String> strings,
														  final Placeholder... placeholders) {
	...
	public static String parsePapiPlaceholders(final Player player,
														String string,
														final Placeholder... placeholders) {
	...
	public static List<String> parsePapiPlaceholders(final Player player,
																	   List<String> strings,
																	   final Placeholder... placeholders) {
		Objects.requireNonNull(player, "Player must not be null");
		Objects.requireNonNull(placeholders, "Placeholders array is null");
	...
	public static List<String> parsePapiPlaceholders(
			final Player player,
